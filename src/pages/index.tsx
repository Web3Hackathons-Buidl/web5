      ...
      <main className={`${theme === 'light' ? 'lightHeroBg' : 'darkHeroBg'} bg-center bg-cover bg-fixed`}>
        <div className='md:px-20 px-8 space-y-4 md:space-y-0 md:flex justify-between items-center py-12 w-full fixed'>
          ...
          <div className='flex gap-x-8 items-center'>
            ...
            <button className='rounded-xl py-2.5 font-semibold greenToPurple px-3 hover:scale-[0.99] duration-200 transition' onClick={openModal}>Login</button>
          </div>
        </div>
        ...
        <div className="max-w-xl flex bg-black/80 text-white p-4 rounded-2xl gap-x-8 mx-auto">
          <div className=" w-1/2">
            ...
            <div className="flex flex-col gap-y-1 my-4">
              <label htmlFor="" className="text-xs text-cyan-400">Email</label>
              <input type="email" name="" id="" className="py-2 px-4 bg-white rounded-lg text-black" placeholder="Email" />
            </div>
            <div className="flex flex-col gap-y-1">
              <label htmlFor="" className="text-xs text-cyan-400">Password</label>
              <div className="w-full bg-white rounded-lg overflow-hidden flex items-center">
                <input type={showPassword ? 'text' : 'password'} name="" id="" className="py-2 border-r outline-none px-4  text-black" placeholder="Password" />
                <button onClick={() => setShowPassword(!showPassword)} className="flex justify-center w-full">
                  <FontAwesomeIcon
            ...
            <div className="mt-6">
              <button className="greenToPurple py-2 px-6 rounded-xl">Log in</button>
            </div>
          </div>
          <div className="w-1/2">
            <h3 className="font-semibold mt-4 text-xl">Share the love</h3>
            <p className="text-sm mt-6 mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus facere delectus eveniet voluptate adipisci voluptates ut?</p>
            <div>
              <div className="flex flex-col gap-y-1 mb-4">
                <label htmlFor="" className="text-xs text-cyan-400">Referral Url</label>
                <div className="w-full bg-white rounded-lg overflow-hidden flex items-center">
                  <input type={'text'} name="" id="" value={'360nft.app/er23rx'} className="py-2 flex-1 border-r outline-none px-4 text-black" placeholder="Password" />
